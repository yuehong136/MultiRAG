...
async def main():
    try:
        ...
        async with sse_client("http://192.168.188.192:9382/sse") as streams:
            async with ClientSession(
                ...
                print(f"{tools.tools=}")
                response = await session.call_tool(name="multirag_retrieval", arguments={"dataset_ids": ["00a2ec6e2fa911f08e81f2debce134a0"], "document_ids": [], "question": "如何休学?"})
