...
This directory contains the plugin mechanism for MultiRAG.

MultiRAG will load plugins from `embedded_plugins` subdirectory recursively.
...
The description will be provided to LLM, and the MultiRAG web frontend for displaying.
...
When you start MultiRAG, you can see your plugin was loaded in the log:
...
def get_metadata(cls) -> LLMToolMetadata:
    return {
        ...
        "name": "bad_calculator",
        # Display name of this tool, providing to MultiRAG frontend
        "displayName": "$t:bad_calculator.name",
        # Description of the usage of this tool, providing to LLM
        "description": "A tool to calculate the sum of two numbers (will give wrong answer)",
        # Description of this tool, providing to MultiRAG frontend
        ...
        "parameters": {
            ...
            "a": {
                ...
                # Description of this parameter, provding to MultiRAG frontend
...
The fields starts with `display` can use a special notation: `$t:xxx`, which will use the i18n mechanism in the MultiRAG frontend, getting text from the `llmTools` category. The frontend will display what you put here if you don't use this notation.
