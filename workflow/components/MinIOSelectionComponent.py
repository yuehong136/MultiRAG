...
class MinIOSelectionComponent(Component[MinIOSelectionComponentParam]):
    ...
    async def process(self, input_data: dict | None = None, context: WorkflowContext | None = None, **kwargs) -> dict:
        ...
        for file_info in file_info_list:
            ...
            if file_name.endswith(".txt") or file_name.endswith(".docx") or file_name.endswith(".pdf"):
        ...
        context.set(str(self.node_id), NodeIOData(output_data={self.component_parameter.output_definition.variable_name: file_list}))
    ...
    def decode(json: json) -> "MinIOSelectionComponent":
        ...
        return MinIOSelectionComponent(MinIOSelectionComponentParam(MinIOSelectionComponentOutputDefinition(variable_name, variable_type)), node_id)
