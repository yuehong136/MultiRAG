...
func (c *MultiRAGClient) PingServer(cmd *Command) (map[string]interface{}, error) {
...
func (c *MultiRAGClient) ListUserDatasets(cmd *Command) (map[string]interface{}, error) {
...
// Returns (result_map, error) - result_map is non-nil for benchmark mode
func (c *MultiRAGClient) ListDatasets(cmd *Command) (map[string]interface{}, error) {
	if c.ServerType != "admin" {
...
// Returns (result_map, error) - result_map is non-nil for benchmark mode
func (c *MultiRAGClient) SearchOnDatasets(cmd *Command) (map[string]interface{}, error) {
	if c.ServerType != "user" {
		return nil, fmt.Errorf("this command is only allowed in USER mode")
	}
...
// Returns (result_map, error) - result_map is non-nil for benchmark mode
func (c *MultiRAGClient) ListUsers(cmd *Command) (map[string]interface{}, error) {
	if c.ServerType != "admin" {
		return nil, fmt.Errorf("this command is only allowed in ADMIN mode")
	}
...
func (c *MultiRAGClient) GrantAdmin(cmd *Command) error {
	if c.ServerType != "admin" {
...
func (c *MultiRAGClient) RevokeAdmin(cmd *Command) error {
	if c.ServerType != "admin" {
		return fmt.Errorf("this command is only allowed in ADMIN mode")
	}
...
func (c *MultiRAGClient) ShowCurrentUser(cmd *Command) (map[string]interface{}, error) {
...
func (c *MultiRAGClient) CreateUser(cmd *Command) error {
	if c.ServerType != "admin" {
		return fmt.Errorf("this command is only allowed in ADMIN mode")
	}
...
func (c *MultiRAGClient) ActivateUser(cmd *Command) error {
	if c.ServerType != "admin" {
		return fmt.Errorf("this command is only allowed in ADMIN mode")
	}
...
func (c *MultiRAGClient) AlterUserPassword(cmd *Command) error {
	if c.ServerType != "admin" {
		return fmt.Errorf("this command is only allowed in ADMIN mode")
	}
...
func (c *MultiRAGClient) DropUser(cmd *Command) error {
	if c.ServerType != "admin" {
		return fmt.Errorf("this command is only allowed in ADMIN mode")
	}
