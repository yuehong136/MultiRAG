...
type User struct {
	...
	IsAuthenticated bool       `gorm:"column:is_authenticated;type:boolean;not null;default:true;index" json:"is_authenticated"`
	IsActive        bool       `gorm:"column:is_active;type:boolean;not null;default:true;index" json:"is_active"`
	IsAnonymous     bool       `gorm:"column:is_anonymous;type:boolean;not null;default:false;index" json:"is_anonymous"`
