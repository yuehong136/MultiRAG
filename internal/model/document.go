...
type Document struct {
	...
	ParserConfig    JSONMap    `gorm:"column:parser_config;type:jsonb;not null" json:"parser_config"`
	...
	MetaFields      *JSONMap   `gorm:"column:meta_fields;type:jsonb" json:"meta_fields,omitempty"`
