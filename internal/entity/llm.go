...
type LLM struct {
	...
	ModelType string  `gorm:"column:mdl_type;size:128;not null;index" json:"model_type"`
...
type MyLLM struct {
	...
	ModelType  *string `gorm:"column:mdl_type" json:"model_type"`
