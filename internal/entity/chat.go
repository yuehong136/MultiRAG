...
type Chat struct {
	...
	LLMSetting             JSONMap   `gorm:"column:llm_setting;type:jsonb;not null" json:"llm_setting"`
	PromptType             string    `gorm:"column:prompt_type;size:16;not null;default:'simple';index" json:"prompt_type"`
	PromptConfig           JSONMap   `gorm:"column:prompt_config;type:jsonb;not null" json:"prompt_config"`
	MetaDataFilter         *JSONMap  `gorm:"column:meta_data_filter;type:jsonb" json:"meta_data_filter,omitempty"`
	...
	SearchMode             *JSONMap  `gorm:"column:search_mode;type:jsonb" json:"search_mode,omitempty"`
...
type ChatSession struct {
	...
	Reference json.RawMessage `gorm:"column:reference;type:jsonb" json:"reference"`
