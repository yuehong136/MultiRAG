...
with st.expander("新建或选择知识库", expanded=True):
    ...
    # 文件上传
    st.file_uploader(
        "上传知识文件:", type=["html", "md", "json", "csv", "pdf", "png", "jpg", "jpeg", "bmp", "eml", "msg", "rst", "rtf", "txt", "xml", "docx", "epub", "odt", "ppt", "pptx", "tsv", "htm"]
    )
...
with st.expander("知识库 samples 中已有文件:", expanded=True):
    ...
    data = {"分词器": ["StructuredFileLoader"], "文档数量": [299], "深文件": ["RecursiveCharacterTextSplitter"]}
