...
class DocGenerator(Message, ABC):
    ...
    def _invoke(self, **kwargs):
        ...
        try:
            ...
            try:
                ...
                self.set_output("_ERROR", f"Document generation failed: {e!s}")
                raise
    ...
    def _resolve_content(self, kwargs: dict[str, Any]) -> str:
