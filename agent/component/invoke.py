...
class Invoke(ComponentBase, ABC):
    ...
    @staticmethod
    def _coerce_json_arg_if_possible(key: str, value: object) -> object:
        raw_value = value
    ...
    def _resolve_variable_value(
        ...
        if variable_name in kwargs:
            value = kwargs[variable_name]
        else:
            value = self._canvas.get_variable_value(variable_name)
    ...
    def _resolve_template_text(self, content: str, kwargs: dict[str, Any] | None = None) -> str:
        return self._render_template(content, self.variable_ref_patt, kwargs, flags=re.DOTALL)

    def _resolve_header_text(self, content: str, kwargs: dict[str, Any] | None = None) -> str:
        return self._render_template(content, self.header_variable_ref_patt, kwargs)

    def _resolve_arg_value(self, para: dict[str, Any], kwargs: dict[str, Any]) -> Any:
    ...
    def _build_request_args(self, kwargs: dict[str, Any]) -> dict[str, Any]:
        args: dict[str, Any] = {}
