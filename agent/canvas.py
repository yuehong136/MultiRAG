...
class Canvas(Graph):
    ...
    async def get_files_async(self, files: list[dict] | None, layout_recognize: str = None) -> list[str]:
        if not files:
            return []
    ...
    def get_files(self, files: list[dict] | None, layout_recognize: str = None) -> list[str]:
        """
