# MultiRAG CLI User Command Reference

This document describes the user commands available in MultiRAG CLI. All commands must end with a semicolon (`;`).
...
**Example**  
```
multirag> CREATE MODEL PROVIDER 'openai' 'sk-...';
```
...
**Example**  
```
multirag> DROP MODEL PROVIDER 'openai';
```
...
**Example**  
```
multirag> SET DEFAULT LLM 'gpt-4';
```
...
**Example**  
```
multirag> SET DEFAULT VLM 'clip-vit-large';
```
...
**Example**  
```
multirag> SET DEFAULT EMBEDDING 'text-embedding-ada-002';
```
...
**Example**  
```
multirag> SET DEFAULT RERANKER 'bge-reranker-large';
```
...
**Example**  
```
multirag> SET DEFAULT ASR 'whisper-large';
```
...
**Example**  
```
multirag> SET DEFAULT TTS 'tts-1';
```
...
**Example**  
```
multirag> RESET DEFAULT EMBEDDING;
```
...
**Example**  
```
multirag> RESET DEFAULT RERANKER;
```
...
**Example**  
```
multirag> CREATE DATASET 'my_dataset' WITH EMBEDDING 'text-embedding-ada-002' PARSER 'pdf';
```
...
**Example**  
```
multirag> CREATE DATASET 'my_dataset' WITH EMBEDDING 'text-embedding-ada-002' PIPELINE 'standard';
```
...
**Example**  
```
multirag> DROP DATASET 'my_dataset';
```
...
**Example**  
```
multirag> LIST FILES OF DATASET 'my_dataset';
```
...
**Example**  
```
multirag> IMPORT '/path/to/doc1.pdf,/path/to/doc2.pdf' INTO DATASET 'my_dataset';
```
...
**Example**  
```
multirag> SEARCH 'What is RAG?' ON DATASETS 'dataset1,dataset2';
```
...
**Example**  
```
multirag> PARSE 'doc1.pdf,doc2.pdf' OF DATASET 'my_dataset';
```
...
**Example**  
```
multirag> PARSE DATASET 'my_dataset' SYNC;
```
...
**Example**  
```
multirag> PARSE DATASET 'my_dataset' ASYNC;
```
