...
class CryptoUtil:
    ...
    def __init__(self, algorithm="aes-256-cbc", key=None, iv=None):
        ...
        if not key:
            raise ValueError("Encryption key not provided and MultiRAG_CRYPTO_KEY environment variable not set")
...
if __name__ == "__main__":
    ...
    test_data = b"Hello, MultiRAG! This is a test for encryption."
