...
class SeaFileConnector(LoadConnector, PollConnector):
    ...
    def __init__(
        ...
        self.token: str | None = None  # account-level
        self.repo_token: str | None = None  # library-scoped
    ...
    def _account_get(self, endpoint: str, params: dict | None = None):
    ...
    def _repo_token_get(self, endpoint: str, params: dict | None = None):
