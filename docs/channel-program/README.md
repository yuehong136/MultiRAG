...
**待办**：CHN-P11 的 API 重启（见下）、CHN-O13（自检的前端接线）·
**最后更新**：2026-08-06
...
### 24 个 PR 全部落地 —— 但 CHN-P11 有一步部署还没做

**CHN-P11 的代码已合**（删 `RuntimeCredential.app_id/app_secret`，即「删字段三步」的
第三步：① 停止读 CHN-P4 ② 停止发 CHN-P8 ③ 删除 CHN-P11）。
