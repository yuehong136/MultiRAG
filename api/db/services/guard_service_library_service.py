...
from api.db.db_models import GuardLibrary, GuardService, GuardServiceLibrary
...
class GuardServiceLibraryService(CommonService):
    ...
    @classmethod
    def get_binding(cls, db: Session, service_id: str, library_id: str) -> GuardServiceLibrary | None:
        """
        获取服务词库绑定关系
