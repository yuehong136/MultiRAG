...
class UserTenantAdmin(ModelView, model=UserTenant):
    ...
    column_list = [UserTenant.id, UserTenant.user_id, UserTenant.tenant_id, UserTenant.role, UserTenant.invited_by, UserTenant.status, UserTenant.create_date, UserTenant.update_date]
...
class LLMFactoriesAdmin(ModelView, model=LLMFactories):
    ...
    column_list = [LLMFactories.name, LLMFactories.logo, LLMFactories.tags, LLMFactories.status, LLMFactories.id, LLMFactories.create_date, LLMFactories.update_date]
...
class LLMAdmin(ModelView, model=LLM):
    ...
    column_list = [LLM.llm_name, LLM.mdl_type, LLM.fid, LLM.max_tokens, LLM.tags, LLM.is_tools, LLM.status, LLM.id, LLM.create_date, LLM.update_date]
...
class TenantLLMAdmin(ModelView, model=TenantLLM):
    ...
    column_list = [
        ...
        TenantLLM.llm_name,
        TenantLLM.api_base,
        TenantLLM.max_tokens,
        TenantLLM.used_tokens,
        TenantLLM.id,
        TenantLLM.create_date,
        TenantLLM.update_date,
    ]
...
class TenantLangfuseAdmin(ModelView, model=TenantLangfuse):
    ...
    column_list = [TenantLangfuse.tenant_id, TenantLangfuse.public_key, TenantLangfuse.host, TenantLangfuse.id, TenantLangfuse.create_date, TenantLangfuse.update_date]
...
class GuardServiceAdmin(ModelView, model=GuardService):
    ...
    column_list = [
        ...
        GuardService.code,
        GuardService.name,
        GuardService.description,
        GuardService.service_type,
        GuardService.enabled_dimensions,
        GuardService.enabled_labels,
        GuardService.policy_config,
        GuardService.cache_enabled,
        GuardService.timeout_ms,
        GuardService.total_requests,
        GuardService.blocked_requests,
        GuardService.tenant_id,
        GuardService.created_by,
        GuardService.status,
        GuardService.create_date,
        GuardService.update_date,
    ]
...
class GuardServiceLibraryAdmin(ModelView, model=GuardServiceLibrary):
    ...
    column_list = [
        GuardServiceLibrary.id,
        GuardServiceLibrary.service_id,
        GuardServiceLibrary.library_id,
        GuardServiceLibrary.enabled,
        GuardServiceLibrary.priority,
        GuardServiceLibrary.library_type,
        GuardServiceLibrary.apply_to_dimensions,
        GuardServiceLibrary.apply_to_labels,
        GuardServiceLibrary.config,
        GuardServiceLibrary.tenant_id,
        GuardServiceLibrary.created_by,
        GuardServiceLibrary.status,
        GuardServiceLibrary.create_date,
        GuardServiceLibrary.update_date,
    ]
...
class GuardRuleAdmin(ModelView, model=GuardRule):
    ...
    column_list = [
        ...
        GuardRule.rule_type,
        GuardRule.content,
        GuardRule.content_hash,
        GuardRule.match_mode,
        GuardRule.case_sensitive,
        GuardRule.config,
        GuardRule.weight,
        GuardRule.priority,
        GuardRule.source,
        GuardRule.description,
        GuardRule.tenant_id,
        GuardRule.created_by,
        GuardRule.status,
        GuardRule.create_date,
        GuardRule.update_date,
    ]
    ...
    column_formatters = {GuardRule.content: lambda m, a: str(m.content)[:100] + "..." if m.content and len(str(m.content)) > 100 else m.content}
...
class GuardLogAdmin(ModelView, model=GuardLog):
    ...
    column_list = [
        GuardLog.id,
        GuardLog.service_id,
        GuardLog.service_code,
        GuardLog.request_id,
        GuardLog.chat_id,
        GuardLog.user_id,
        GuardLog.tenant_id,
        GuardLog.content_hash,
        GuardLog.content_length,
        GuardLog.content_preview,
        GuardLog.is_blocked,
        GuardLog.risk_score,
        GuardLog.content_risk_level,
        GuardLog.content_results,
        GuardLog.sensitive_level,
        GuardLog.sensitive_results,
        GuardLog.attack_level,
        GuardLog.attack_results,
        GuardLog.customized_hits,
        GuardLog.risk_words,
        GuardLog.sensitive_data,
        GuardLog.action_taken,
        GuardLog.action_detail,
        GuardLog.source_type,
        GuardLog.source_id,
        GuardLog.client_ip,
        GuardLog.user_agent,
        GuardLog.process_time_ms,
        GuardLog.cloud_service_used,
        GuardLog.create_date,
        GuardLog.update_date,
    ]
    column_sortable_list = [GuardLog.create_date, GuardLog.risk_score]
    column_default_sort = [(GuardLog.create_date, True)]
    can_create = False
    can_edit = False
    column_formatters = {GuardLog.content_preview: lambda m, a: str(m.content_preview)[:100] + "..." if m.content_preview and len(str(m.content_preview)) > 100 else m.content_preview}
...
class GuardLibraryItemAdmin(ModelView, model=GuardLibraryItem):
    ...
    column_list = [
        GuardLibraryItem.id,
        GuardLibraryItem.library_id,
        GuardLibraryItem.content,
        GuardLibraryItem.content_hash,
        GuardLibraryItem.content_type,
        GuardLibraryItem.item_metadata,
        GuardLibraryItem.hit_count,
        GuardLibraryItem.last_hit_time,
        GuardLibraryItem.sort_order,
        GuardLibraryItem.tenant_id,
        GuardLibraryItem.status,
        GuardLibraryItem.create_date,
        GuardLibraryItem.update_date,
    ]
    ...
    column_formatters = {GuardLibraryItem.content: lambda m, a: str(m.content)[:100] + "..." if m.content and len(str(m.content)) > 100 else m.content}
...
class GuardLibraryAdmin(ModelView, model=GuardLibrary):
    ...
    column_list = [
        GuardLibrary.id,
        GuardLibrary.library_type,
        GuardLibrary.name,
        GuardLibrary.description,
        GuardLibrary.category,
        GuardLibrary.tags,
        GuardLibrary.config,
        GuardLibrary.item_count,
        GuardLibrary.hit_count,
        GuardLibrary.last_hit_time,
        GuardLibrary.version,
        GuardLibrary.tenant_id,
        GuardLibrary.created_by,
        GuardLibrary.status,
        GuardLibrary.create_date,
        GuardLibrary.update_date,
    ]
...
class GuardLabelAdmin(ModelView, model=GuardLabel):
    ...
    column_list = [
        GuardLabel.id,
        GuardLabel.dimension_id,
        GuardLabel.code,
        GuardLabel.name,
        GuardLabel.description,
        GuardLabel.cloud_label,
        GuardLabel.cloud_label_type,
        GuardLabel.detection_ranges,
        GuardLabel.enabled,
        GuardLabel.risk_score,
        GuardLabel.risk_level,
        GuardLabel.sensitive_level,
        GuardLabel.action,
        GuardLabel.action_config,
        GuardLabel.sort_order,
        GuardLabel.tenant_id,
        GuardLabel.created_by,
        GuardLabel.status,
        GuardLabel.create_date,
        GuardLabel.update_date,
    ]
...
class GuardLabelLibraryAdmin(ModelView, model=GuardLabelLibrary):
    ...
    column_list = [
        GuardLabelLibrary.id,
        GuardLabelLibrary.label_id,
        GuardLabelLibrary.library_id,
        GuardLabelLibrary.enabled,
        GuardLabelLibrary.priority,
        GuardLabelLibrary.config,
        GuardLabelLibrary.conditions,
        GuardLabelLibrary.tenant_id,
        GuardLabelLibrary.created_by,
        GuardLabelLibrary.status,
        GuardLabelLibrary.create_date,
        GuardLabelLibrary.update_date,
    ]
...
class GuardDimensionAdmin(ModelView, model=GuardDimension):
    ...
    column_list = [
        ...
        GuardDimension.code,
        GuardDimension.name,
        GuardDimension.description,
        GuardDimension.enabled,
        GuardDimension.config,
        GuardDimension.sort_order,
        GuardDimension.tenant_id,
        GuardDimension.created_by,
        GuardDimension.status,
        GuardDimension.create_date,
        GuardDimension.update_date,
    ]
...
class DocumentAdmin(ModelView, model=Document):
    ...
    column_formatters = {Document.progress_msg: lambda m, a: str(m.progress_msg)[:100] + "..." if m.progress_msg and len(str(m.progress_msg)) > 100 else m.progress_msg}
...
class FileAdmin(ModelView, model=File):
    ...
    column_list = [File.id, File.parent_id, File.tenant_id, File.created_by, File.name, File.location, File.size, File.type, File.source_type, File.create_date, File.update_date]
...
class File2DocumentAdmin(ModelView, model=File2Document):
    ...
    column_list = [File2Document.id, File2Document.file_id, File2Document.document_id, File2Document.create_date, File2Document.update_date]
...
class ConversationAdmin(ModelView, model=Conversation):
    ...
    column_list = [Conversation.id, Conversation.dialog_id, Conversation.name, Conversation.message, Conversation.reference, Conversation.user_id, Conversation.create_date, Conversation.update_date]
...
class APITokenAdmin(ModelView, model=APIToken):
    ...
    column_list = [APIToken.tenant_id, APIToken.name, APIToken.description, APIToken.dialog_id, APIToken.source, APIToken.beta, APIToken.id, APIToken.create_date, APIToken.update_date]
...
class CanvasTemplateAdmin(ModelView, model=CanvasTemplate):
    ...
    column_list = [
        CanvasTemplate.id,
        CanvasTemplate.avatar,
        CanvasTemplate.title,
        CanvasTemplate.description,
        CanvasTemplate.canvas_type,
        CanvasTemplate.dsl,
        CanvasTemplate.create_date,
        CanvasTemplate.update_date,
    ]
...
class UserCanvasVersionAdmin(ModelView, model=UserCanvasVersion):
    ...
    column_list = [
        ...
        UserCanvasVersion.description,
        UserCanvasVersion.dsl,
        UserCanvasVersion.create_date,
        UserCanvasVersion.update_date,
    ]
...
class WritingProjectAdmin(ModelView, model=WritingProject):
    ...
    column_list = [
        WritingProject.id,
        WritingProject.user_input,
        WritingProject.content_type,
        WritingProject.language_style,
        WritingProject.word_count,
        WritingProject.reference,
        WritingProject.model,
        WritingProject.title,
        WritingProject.user_id,
        WritingProject.status,
        WritingProject.create_date,
        WritingProject.update_date,
    ]
    ...
    column_formatters = {WritingProject.user_input: lambda m, a: str(m.user_input)[:100] + "..." if m.user_input and len(str(m.user_input)) > 100 else m.user_input}
...
class WritingChapterAdmin(ModelView, model=WritingChapter):
    ...
    column_list = [
        WritingChapter.id,
        WritingChapter.project_id,
        WritingChapter.title,
        WritingChapter.summary,
        WritingChapter.level,
        WritingChapter.parent_id,
        WritingChapter.order_index,
        WritingChapter.status,
        WritingChapter.create_date,
        WritingChapter.update_date,
    ]
...
class WritingReferenceMaterialAdmin(ModelView, model=WritingReferenceMaterial):
    ...
    column_list = [
        WritingReferenceMaterial.id,
        WritingReferenceMaterial.chapter_id,
        WritingReferenceMaterial.title,
        WritingReferenceMaterial.content,
        WritingReferenceMaterial.source,
        WritingReferenceMaterial.type,
        WritingReferenceMaterial.order_index,
        WritingReferenceMaterial.status,
        WritingReferenceMaterial.create_date,
        WritingReferenceMaterial.update_date,
    ]
    ...
    column_formatters = {WritingReferenceMaterial.content: lambda m, a: str(m.content)[:100] + "..." if m.content and len(str(m.content)) > 100 else m.content}
...
class WritingChapterContentAdmin(ModelView, model=WritingChapterContent):
    ...
    column_list = [
        WritingChapterContent.id,
        WritingChapterContent.chapter_id,
        WritingChapterContent.content,
        WritingChapterContent.status,
        WritingChapterContent.create_date,
        WritingChapterContent.update_date,
    ]
    column_sortable_list = [WritingChapterContent.create_date]
    column_default_sort = [(WritingChapterContent.create_date, True)]
    column_formatters = {WritingChapterContent.content: lambda m, a: str(m.content)[:200] + "..." if m.content and len(str(m.content)) > 200 else m.content}
...
class AskDataHistoryAdmin(ModelView, model=AskDataHistory):
    ...
    column_list = [
        AskDataHistory.id,
        AskDataHistory.conversation_id,
        AskDataHistory.ask_id,
        AskDataHistory.user_id,
        AskDataHistory.data,
        AskDataHistory.status,
        AskDataHistory.user_question,
        AskDataHistory.round_id,
        AskDataHistory.processed_semantic_layer,
        AskDataHistory.sql_info,
        AskDataHistory.create_date,
        AskDataHistory.update_date,
    ]
...
class ApiEnvironmentAdmin(ModelView, model=ApiEnvironment):
    ...
    column_list = [
        ApiEnvironment.id,
        ApiEnvironment.tenant_id,
        ApiEnvironment.name,
        ApiEnvironment.description,
        ApiEnvironment.base_url,
        ApiEnvironment.is_default,
        ApiEnvironment.is_global,
        ApiEnvironment.status,
        ApiEnvironment.create_date,
        ApiEnvironment.update_date,
    ]
...
class ApiEnvironmentVariableAdmin(ModelView, model=ApiEnvironmentVariable):
    ...
    column_list = [
        ApiEnvironmentVariable.id,
        ApiEnvironmentVariable.environment_id,
        ApiEnvironmentVariable.key_name,
        ApiEnvironmentVariable.key_value,
        ApiEnvironmentVariable.description,
        ApiEnvironmentVariable.is_secret,
        ApiEnvironmentVariable.variable_type,
        ApiEnvironmentVariable.status,
        ApiEnvironmentVariable.create_date,
        ApiEnvironmentVariable.update_date,
    ]
    ...
    column_formatters = {ApiEnvironmentVariable.key_value: lambda m, a: "***" if m.is_secret else str(m.key_value)[:50]}
...
class GlobalApiEnvironmentAdmin(ModelView, model=GlobalApiEnvironment):
    ...
    column_list = [
        GlobalApiEnvironment.id,
        GlobalApiEnvironment.name,
        GlobalApiEnvironment.description,
        GlobalApiEnvironment.server_url,
        GlobalApiEnvironment.variables,
        GlobalApiEnvironment.is_active,
        GlobalApiEnvironment.status,
        GlobalApiEnvironment.create_date,
        GlobalApiEnvironment.update_date,
    ]
...
class MCPServerAdmin(ModelView, model=MCPServer):
    ...
    column_list = [
        ...
        MCPServer.variables,
        MCPServer.headers,
        MCPServer.create_date,
        MCPServer.update_date,
    ]
...
class ToolsDataAdmin(ModelView, model=ToolsData):
    ...
    column_list = [ToolsData.flow_id, ToolsData.user_id, ToolsData.meta_data, ToolsData.final_data, ToolsData.id, ToolsData.create_date, ToolsData.update_date]
...
class SearchAdmin(ModelView, model=Search):
    ...
    column_list = [Search.id, Search.avatar, Search.tenant_id, Search.name, Search.description, Search.created_by, Search.search_config, Search.status, Search.create_date, Search.update_date]
    ...
    column_formatters = {Search.description: lambda m, a: str(m.description)[:100] + "..." if m.description and len(str(m.description)) > 100 else m.description}
