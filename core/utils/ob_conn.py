...
from core.utils.doc_store_conn import DocStoreConnection, MatchExpr, OrderByExpr, FusionExpr, MatchTextExpr, \
    MatchDenseExpr
...
class OBConnection(DocStoreConnection):
    ...
    def search(
        ...
        **kwargs,
        ...
        for m in matchExprs:
            if isinstance(m, MatchTextExpr):
                fulltext_query = m.raw_text or m.extra_options.get("original_query", m.matching_text)
