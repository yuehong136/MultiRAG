...
logger = logging.getLogger("multirag.infinity_conn")
    ...
    def get(self, chunkId: str, indexName: str, knowledgebaseIds: list[str]) -> dict | None:
        ...
        for knowledgebaseId in knowledgebaseIds:
            ...
            try:
                ...
                logger.warning(f"Table not found: {table_name}, this dataset base isn't created in Infinity. Maybe it is created in other document engine.")
                continue
