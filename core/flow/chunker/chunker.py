...
from core.flow.chunker.schema import ChunkerFromUpstream
    ...
    async def _invoke(self, **kwargs):
        ...
        async def auto_keywords():
            ...
            with db_connection() as db:
                chat_mdl = LLMBundle(db, self._canvas._tenant_id, LLMType.CHAT, llm_name=llm_setting["llm_name"], lang=llm_setting["lang"])
