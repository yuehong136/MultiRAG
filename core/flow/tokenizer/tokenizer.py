...
class Tokenizer(ProcessBase):
    ...
    async def _invoke(self, **kwargs):
        ...
        if "full_text" in self._param.search_method:
            ...
            # Branch on declared format or present chunks so empty chunk lists stay on the chunk path.
            if from_upstream.output_format == "chunks" or from_upstream.chunks is not None:
